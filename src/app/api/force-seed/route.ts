...
export async function POST(request: NextRequest) {
  try {
    console.log('🌱 Starting force seed process...');
    ...
    console.log('📊 Created performance data');
    ...
    console.log('🛡️ Created risk assessment');
    ...
    console.log('📊 Created risk breakdown');
    ...
    console.log('📊 Created risk history');
    ...
    return NextResponse.json({
      ...
      nextSteps: [
        ...
        'Check /api/financial-data endpoint',
        'Check /api/risk-assessment endpoint',
